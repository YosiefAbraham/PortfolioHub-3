      ...
      >
        <DialogContent className="max-w-4xl max-h-[90vh] p-0 gap-0 flex flex-col">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 space-y-3">
                <DialogTitle
                  ...
                  data-testid={`text-modal-title-${project.title
                    .toLowerCase()
                    .replace(/\s/g, "-")}`}
                >
                  {project.title}
            ...
            <div className="flex flex-col gap-3 pt-4">
              {project.projectUrl && (
                <Button
                  ...
                  size="lg"
                  asChild
                  data-testid="button-modal-project"
                  className="w-full"
                >
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {project.assumptionsUrl && (
                  <Button
                    ...
                    size="sm"
                    asChild
                    data-testid="button-modal-assumptions"
                  >
                    <a
                      href={project.assumptionsUrl}
                      target="_blank"
                      rel="noreferrer"
                    >
                      <FileText className="h-4 w-4 mr-2" />
                ...
                {project.marketAnalysisUrl && (
                  <Button
                    ...
                    size="sm"
                    asChild
                    data-testid="button-modal-market"
                  >
                    <a
                      href={project.marketAnalysisUrl}
                      target="_blank"
                      rel="noreferrer"
                    >
                      <FileText className="h-4 w-4 mr-2" />
          ...
          <ScrollArea
            ...
            data-testid="scroll-project-details"
          >
            <div className="px-6 py-6 space-y-8">
              ...
              {project.longDescription && (
                <div className="space-y-3">
                  ...
                  <p
                    ...
                    data-testid="text-modal-long-description"
                  >
                    {project.longDescription}
                  </p>
                </div>
              ...
              {project.challenges && (
                <div className="space-y-3">
                  ...
                  <p
                    className="text-base leading-relaxed"
                    data-testid="text-modal-challenges"
                  >
                    {project.challenges}
                  </p>
                </div>
              ...
              {project.outcome && (
                <div className="space-y-3">
                  ...
                  <p
                    className="text-base leading-relaxed"
                    data-testid="text-modal-outcome"
                  >
                    {project.outcome}
                  </p>
                </div>
